...
const Dashboard: React.FC = () => {
  ...
  const handleTablePageChange = (newPage: number) => {
    ...
    fetchTableData(newPage, tableSelectedRoom);
  };

  const handleTableRoomChange = (newRoom: string) => {
    setTableSelectedRoom(newRoom);
    setTableCurrentPage(1); // Reset to page 1
    fetchTableData(1, newRoom);
  };
